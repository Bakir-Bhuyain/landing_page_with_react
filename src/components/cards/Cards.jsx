                        ...
                        {cards.map((card, index) => (
                              ...
                              >
                                ...
                                ${card.badge === 'Best Seller' ? 'bg-orange-50 text-orange-600' :
                                    ...
                                    <button className="w-full py-4 bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-bold rounded-2xl transition-all shadow-lg shadow-purple-100 hover:cursor-pointer">
                                          Buy Now
                                    </button>
                              </div>
                        ))}
